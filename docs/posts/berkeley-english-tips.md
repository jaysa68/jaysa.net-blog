---
title: 10 UC Berkeley English Major Tips
date:
    created: 2026-02-25
categories:
    - Writing
...
This is less necessary if I've given myself a lot of time to write and iterate. But, if I just start writing a paper without an outline, not only I find it harder form each sentence, but each section may be outsized relative to its importance to my argument. I'll go off on tangents and create a lot of writing that eventually gets deleted, which for is great for increasing understanding (hence, a beneficial approach when I start early), but bad for getting the paper done in a reasonable timespan. Often, I have the rough structure down on the document beforehand.

For example, say I need to write a 5 page paper. I'll allocate pages 1 and 5 for the introduction and conclusion, and maybe have my initial thesis set up on one of these. Next, I'll do the first sentence for page 1, then page 2, then page 3, each corresponding to a particular topic I need to expand on to support my thesis. The topic sentences of pages 2-4 should make some sense read in sequence. The order probably matters, since each point builds on what's established before it; I may re-order them until I'm confident there's direction from one sentence to the next. Only then will I actually start the bulk of my writing. Each point may not perfectly fit in a full page, but I try to do this intentionally. Page 3 (or words 500-1000, however I'm divvying up sections) may end up a bit longer than page 2, which is fine if I hit the expected length in the end, but I try not to go overboard with changing the proportions.

## 10. Read out loud before turning it in

I'll do this for assignments of any size, and also writing outside of school. You'll catch little errors: missed in-text citations, typos, or overcomplicated grammar. I start at the top and read aloud, and if I cringe at some section, I'll make the tweak and the continue reading. Once I can read through the entire piece once out loud without making any changes partway through, it's ready to turn in. I'm too shy and disorganized to find time to read aloud to other people, but that would probably be beneficial too. Maybe someday...
